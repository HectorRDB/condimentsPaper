...
p <- plot_reduced_dim_together(fork_sce)
p +
  annotate("text", x = -.1, y = -.5, label = "Start", size = 5) +
  annotate("text", x = .35, y = .1, label = "Lineage 1", size = 5) +
  annotate("text", x = -.2, y = .42, label = "Lineage 2", size = 5)
```

```{r, fig.height=5, fig.width=6}
data("tree_sce", package = "condimentsPaper")
p <- plot_reduced_dim_together(tree_sce)
p +
  annotate("text", x = .1, y = .4, label = "Start", size = 5) +
  annotate("text", x = -.25, y = -.35, label = "Lineage 1", size = 5) +
  annotate("text", x = .2, y = -.4, label = "Lineage 2", size = 5) +
  annotate("text", x = .25, y = -.15, label = "Lineage 3", size = 5)
```

```{r, fig.height=5, fig.width=6}
data("complex_sce", package = "condimentsPaper")
p <- plot_reduced_dim_together(complex_sce)
p +
  annotate("text", x = -.15, y = -.35, label = "Start", size = 5) +
  annotate("text", x = .35, y = .2, label = "Lineage 1", size = 5) +
  annotate("text", x = -.3, y = .2, label = "Lineage 2", size = 5)
```
